...
import com.nevesti.www.bairroseguro.util.NetworkCheck;
import com.nevesti.www.bairroseguro.util.validation.Rule;
import com.nevesti.www.bairroseguro.util.validation.Validator;
...
public class ActivityUserLogin extends AppCompatActivity implements Validator.ValidationListener {
    ...
    @TextRule(order = 5, minLength = 6, message = "Insira uma senha corretamente")
    ...
    public void onValidationFailed(View failedView, Rule<?> failedRule) {
        ...
        if (failedView instanceof EditText) {
            ...
            Toast.makeText(this, "Registro não foi salvo", Toast.LENGTH_SHORT).show();
        }
    }
