...
import com.nevesti.www.bairroseguro.fragment.FragmentCategory;
import com.nevesti.www.bairroseguro.fragment.FragmentFavorite;
import com.nevesti.www.bairroseguro.fragment.FragmentProfile;
import com.nevesti.www.bairroseguro.fragment.FragmentRecent;
import com.nevesti.www.bairroseguro.fragment.FragmentVideo;
import com.nevesti.www.bairroseguro.util.AppBarLayoutBehavior;
import com.nevesti.www.bairroseguro.util.Constant;
import com.nevesti.www.bairroseguro.util.GDPR;
...
public class NoticiasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (intent.getAction().equals(Constant.REGISTRATION_COMPLETE)) {
                    ...
                    Toast.makeText(getApplicationContext(), "Notificação: " + message, Toast.LENGTH_LONG).show();
                }
            }
        };
        ...
        if (message != null) {
            ...
            LayoutInflater layoutInflaterAndroid = LayoutInflater.from(NoticiasActivity.this);
            View mView = layoutInflaterAndroid.inflate(R.layout.custom_dialog_notif, null);

            final AlertDialog.Builder alert = new AlertDialog.Builder(NoticiasActivity.this);
            alert.setView(mView);
            ...
            if (imageUrl.endsWith(".jpg") || imageUrl.endsWith(".jpeg") || imageUrl.endsWith(".png") || imageUrl.endsWith(".gif")) {
                ...
                Picasso.with(NoticiasActivity.this)
