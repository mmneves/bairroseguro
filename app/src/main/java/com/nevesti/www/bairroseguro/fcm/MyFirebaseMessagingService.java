package com.nevesti.www.bairroseguro.fcm;
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                //    displayNotificationMessage(getApplicationContext(), title, message, pushNotification);
                //} else {
                //    displayNotificationMessageWithBigImage(getApplicationContext(), title, message, pushNotification, imageUrl);
                //}

            } else {
                // app is in background, show the notification in notification tray
                Intent resultIntent = new Intent(getApplicationContext(), NoticiasActivity.class);
